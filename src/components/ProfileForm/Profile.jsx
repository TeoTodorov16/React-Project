...
import ProfileImage from "../../assets/b112b6db-0fa4-4a2e-ae0e-a8ece6db0d06.png"
...
function Profile() {
	...
	return (
		<header>
			 <svg xmlns="http://www.w3.org/2000/svg" width="148.301" height="182.362" viewBox="0 0 378.301 82.362">
			...
			<nav ref={navRef}>
				<a href="" onClick={sendHome}>LIBRARY</a>
				<a href="" onClick={SendSettings}>SETTINGS</a>
